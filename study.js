...
function draw(){
    ...
    if(Status != ""){
        ...
        for(i=0 ; i < array.length ; i++){
            document.getElementById("status_study").innerHTML = "Status: Objects Detected!!";
            document.getElementById("no_of_objects(study)").innerHTML = "Number of objects detected are: "+array.length;
            fill(r,g,b);
